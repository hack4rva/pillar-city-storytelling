...
problem_statement: arts-discovery | civic-storytelling | neighborhood-history | general
tags:
  - [tag1]
  - [tag2]
...
Add a row to the correct section:

```markdown
- [`SECTION_N_topic_slug.md`](SECTION_N_topic_slug.md) — Short description matching the report's actual content
```
...
Add a new row:
```
| E-NNN | [claim description] | [official URL] | [access date] | Confirmed | [notes] |
```
