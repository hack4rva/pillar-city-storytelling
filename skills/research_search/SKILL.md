...
description: Use when answering questions that require facts, evidence, personas, data sources, risks, or prior art from the A City That Tells Its Stories pillar research corpus. Use when a team asks about Richmond arts events, civic storytelling, oral history, neighborhood history, data availability, MVP feasibility, demo strategy, or risks — before answering from memory.
---
...
Cite the source file when stating facts (e.g., "per A1_problem_landscape_arts_discovery").
...
|---------------|-----------|
| "What data exists for arts events?" | D1–D5 |
...
| "What should we NOT build?" | F5, 92, G1, G3 |

## Rules

- **Never answer from memory** when the question is about Richmond-specific facts, programs, data, or arts/storytelling specifics. Always check the index first.
