...
3. **Step 3 (20–35s)**: User selects an anchor card (e.g., "moe. — Born to Fly Tour (Night 1)" at The Broadberry [7] or "Dominion Energy Jazz Café" at VMFA [5]).
...
4. **0:35**: Back, search "Broadberry" → "moe. — Born to Fly Tour (Night 1) — Tue Mar 17, Doors 7 pm" [7] → open; show "Get Tickets (Etix)."
...
1. *WE DO. A LOT.  | DoStuff*. https://dostuffmedia.com/our-cities
...
4. *
    Music & Concerts Events in Richmond, VA - Live Music, Dances | Eventbrite
*. https://www.eventbrite.com/b/va--richmond/music/
