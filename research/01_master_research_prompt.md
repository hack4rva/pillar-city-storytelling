...
| Style Weekly Events | Style Weekly | styleweekly.com/events/ | Public form | Unknown | N/A | Partially verified | Submission form confirmed; feed unknown [10] [11] |
...
* **Style Weekly:** A submission form is confirmed, but feed status is unknown—teams should avoid HTML scraping this weekend to prevent fragility [11].
...
* **Richmond-local:** The status of DoRichmond/Do804 is currently unknown and requires verification. VPM Artsline and VisitRichmond calendars exist, but their feed availability needs validation.
...
Reduce risk before coding by validating the following:
* DoStuff/Do804 or DoRichmond status and any feeds/APIs.
* VPM Artsline and VisitRichmond events—are RSS/ICS available?
...
3. *
    ...
    *. https://rvalibrary.libcal.com/calendars
...
6. *
                ...
                LibCal -
        Richmond Public Library
    *. https://rvalibrary.libcal.com/calendar/westend
